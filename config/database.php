    ...
    */
    ...
    'connections' => [
        ...
        'mariadb' => [
            'driver' => 'mariadb',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST', '172.17.56.111'),
            'port' => env('DB_PORT', '3307'),
            'database' => env('DB_DATABASE', 'uct'),
            'username' => env('DB_USERNAME', 'root'),
        ...
        'sqlsrv' => [
            ...
            'host' => env('DB_HOST', '172.17.56.117'),
            // 'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '1433'),
            'database' => env('DB_DATABASE', 'SBOLIVE_JLRC'),
            'username' => env('DB_USERNAME', 'sa'),
            'password' => env('DB_PASSWORD', 'Sb1@JLRC'),
            // 'password' => env('DB_PASSWORD', 'sB1@JLRC'),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
