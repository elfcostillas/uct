...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'plate_no'=> 'required|string|max:255|unique:vehicles,plate_no,' . $this->id,
            'veh_identification_no'=> 'nullable|string|max:255|unique:vehicles,veh_identification_no,' . $this->id,
            ...
            'veh_code'=> 'nullable|string|max:255|unique:vehicles,veh_code,' . $this->id,
